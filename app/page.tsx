  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="">
              <div className="relative">
                ...
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                  ...
                  {/* Hero Section */}
      <section id="home" className="relative bg-neutral-dark text-white">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-24 left-6 bg-red-500 hover:bg-red-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 z-50 group"
      ...
      >
        ...
        <div className="absolute left-16 bg-white text-gray-800 px-3 py-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
          Visit YouTube Channel
          <div className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/2 w-2 h-2 bg-white rotate-45"></div>
        </div>
      </a>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 left-6 bg-green-500 hover:bg-green-600 text-white px-6 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 z-50 group flex items-center"
